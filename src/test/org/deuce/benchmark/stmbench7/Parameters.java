...
public class Parameters
{
	 ...
	 */
	public static final int NumAtomicPerComp = 200, NumConnPerAtomic = 6,
			DocumentSize = 20000, ManualSize = 1000000, NumCompPerModule = 500,
			NumAssmPerAssm = 3, NumAssmLevels = 7, NumCompPerAssm = 3,
	 ...
	 */
	public static final int InitialTotalCompParts = NumModules
			* NumCompPerModule, InitialTotalBaseAssemblies = (int) Math.pow(
			NumAssmPerAssm, NumAssmLevels - 1),
			InitialTotalComplexAssemblies = (1 - (int) Math.pow(NumAssmPerAssm,
	 ...
	 * source code).
	 */
	public static final int MinModuleDate = 1000, MaxModuleDate = 1999,
			MinAssmDate = 1000, MaxAssmDate = 1999, MinAtomicDate = 1000,
			MaxAtomicDate = 1999, MinOldCompDate = 0, MaxOldCompDate = 999,
			MinYoungCompDate = 2000, MaxYoungCompDate = 2999,
			YoungCompFrac = 10, TypeSize = 10, NumTypes = 10, XYRange = 100000,
			TitleSize = 40;

	/**
	 * Ratios of various operation types (in percents).
	 */
	public static final int TraversalsRatio = 5, ShortTraversalsRatio = 40,
			OperationsRatio = 45, StructuralModificationsRatio = 10;
