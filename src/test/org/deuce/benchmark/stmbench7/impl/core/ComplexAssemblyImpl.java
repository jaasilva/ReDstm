		...
		ComplexAssembly
{
	...
	public ComplexAssemblyImpl(int id, String type, int buildDate,
	...
	public boolean addSubAssembly(Assembly assembly)
	{
		if (assembly instanceof BaseAssembly && level != 2)
			throw new RuntimeError(
					"ComplexAssembly.addAssembly: BaseAssembly at wrong level!");
	...
	public String toString()
	{
		...
		subAssString += "}";
		return super.toString() + ", level=" + level + ", subAssemblies="
				+ subAssString;
	}
}
