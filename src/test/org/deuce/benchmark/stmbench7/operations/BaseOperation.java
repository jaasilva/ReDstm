...
public abstract class BaseOperation implements Operation
{
	...
	{
		LargeSet<AtomicPart> newSet = BackendFactory.instance
				.<AtomicPart> createLargeSet();
		newSet.add(atomicPart);
		LargeSet<AtomicPart> sameDateSet = atomicPartBuildDateIndex
				.putIfAbsent(atomicPart.getBuildDate(), newSet);
		if (sameDateSet != null)
