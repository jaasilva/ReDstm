...
public class StructuralModification8 extends StructuralModification7
{
	...
	{
		int complexAssemblyId = ThreadRandom
				.nextInt(Parameters.MaxComplexAssemblies) + 1;
		ComplexAssembly complexAssembly = complexAssemblyIdIndex
				.get(complexAssemblyId);
		...
		if (superAssembly == null
				|| superAssembly.getSubAssemblies().size() == 1)
			throw new OperationFailedException();
