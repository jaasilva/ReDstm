...
public class Query2 extends BaseOperation
{
	...
	protected Query2(Setup oo7setup, int percent)
	{
		...
		this.minAtomicDate = Parameters.MaxAtomicDate - percent
				* (Parameters.MaxAtomicDate - Parameters.MinAtomicDate) / 100;
	}
	...
	{
		Iterable<LargeSet<AtomicPart>> partSets = partBuildDateIndex.getRange(
				minAtomicDate, maxAtomicDate);
		int count = 0;
