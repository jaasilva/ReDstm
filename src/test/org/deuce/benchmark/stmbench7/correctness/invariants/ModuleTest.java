...
public class ModuleTest extends InvariantTest
{
	...
	public static void checkInvariants(Module module, boolean initial,
			TraversedObjects traversedObjects)
	{
		DesignObjTest.checkInvariants(module, initial, 1,
				Parameters.MinModuleDate, Parameters.MaxModuleDate);
		...
		ComplexAssemblyTest.checkInvariants(rootAssembly, initial, null,
