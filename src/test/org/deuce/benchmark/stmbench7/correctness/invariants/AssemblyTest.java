...
public class AssemblyTest extends InvariantTest
{
	...
	public static void checkInvariants(Assembly assembly, boolean initial,
			int maxId, ComplexAssembly parentAssembly, Module module)
	{

		DesignObjTest.checkInvariants(assembly, initial, maxId,
				Parameters.MinAssmDate, Parameters.MaxAssmDate);

		int id = assembly.getId();

		if (assembly.getSuperAssembly() != parentAssembly)
			reportError(assembly, id,
					"invalid reference to the parent ComplexAssembly");
