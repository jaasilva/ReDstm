...
public class DocumentationTest extends InvariantTest
{
			...
			CompositePart component, TraversedObjects traversedObjects)
	{
		...
		if (documentation.getCompositePart() != component)
			reportError(documentation, id,
					"invalid reference to CompositePart parent");

		String title = documentation.getTitle(), titleShouldBe = "Composite Part #"
				+ component.getId();
		if (!title.equals(titleShouldBe))
			reportError(documentation, id, "title", titleShouldBe, title);

		String text = documentation.getText();
		if (!text.startsWith("I am the documentation for composite part #"
				+ component.getId())
				&& !text.startsWith("This is the documentation for composite part #"
						+ component.getId()))
			reportError(documentation, id, "text (prefix)",
					"I am / This is the documentation for composite part #...",
					text.substring(0, 30));
	}
}
