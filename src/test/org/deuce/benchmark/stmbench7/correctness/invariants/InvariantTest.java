...
public class InvariantTest
{
	...
	protected static void reportError(Object obj, int id, String message)
	{
		...
		if (id > 0)
			withId = " with id = " + id;
		throw new RuntimeError("Invariant violated! Object "
				+ obj.getClass().getName() + withId + ": " + message);
	}

	protected static void reportError(Object obj, int id, String attribute,
	...
	protected static void reportError(Object obj, int id, String attribute,
			int expectedMin, int expectedMax, int found)
	{
		reportError(obj, id, "attribute " + attribute
				+ " --> expected value in [" + expectedMin + "," + expectedMax
				+ "], found = " + found);
	}
