...
public class StructureComparisonOperation implements Operation
{
	...
	private void checkModulesEqual()
	{
		...
		ComplexAssembly root1 = module1.getDesignRoot(), root2 = module2
				.getDesignRoot();
	...
	private void checkDesignObjEqual(DesignObj obj1, DesignObj obj2)
	{
		...
		checkEqual(obj1.getBuildDate(), obj2.getBuildDate(), obj1, id1, obj2,
				id2, "buildDate");
	}
	...
	private void checkManualsEqual(Manual man1, Manual man2)
	{
		...
		checkEqual(man1.getTitle(), man2.getTitle(), man1, id1, man2, id2,
				"title");
		checkEqual(man1.getText(), man2.getText(), man1, id1, man2, id2, "text");
		checkReferences(man1.getModule(), man2.getModule(), man1, id1, man2,
				id2, "module");
	}
	...
	private void checkAssembliesEqual(Assembly assembly1, Assembly assembly2)
	{
		...
		checkReferences(assembly1.getSuperAssembly(),
				assembly2.getSuperAssembly(), assembly1, id1, assembly2, id2,
				"superAssembly");
		...
		if (!assembly1.getClass().equals(assembly2.getClass()))
			...
			if (assembly1 instanceof ComplexAssembly)
			{
				if (!(assembly2 instanceof ComplexAssembly))
					reportError(assembly1, id1, assembly2, id2,
							"objects of different classes");
				checkComplexAssembliesEqual((ComplexAssembly) assembly1,
			...
			else
			{
				if (!(assembly2 instanceof BaseAssembly))
					reportError(assembly1, id1, assembly2, id2,
							"objects of different classes");
				checkBaseAssembliesEqual((BaseAssembly) assembly1,
	...
	{
		int id1 = assembly1.getId(), id2 = assembly2.getId();
		checkEqual(assembly1.getLevel(), assembly2.getLevel(), assembly1, id1,
				assembly2, id2, "level");

		ImmutableCollection<Assembly> subAss1 = assembly1.getSubAssemblies(), subAss2 = assembly2
				.getSubAssemblies();
		checkEqual(subAss1.size(), subAss2.size(), assembly1, id1, assembly2,
				id2, "subAssemblies.size()");

		Iterator<Assembly> it1 = subAss1.iterator(), it2 = subAss2.iterator();
		while (it1.hasNext())
		{
			Assembly child1 = it1.next(), child2 = it2.next();
			checkReferences(child1, child2, assembly1, id1, assembly2, id2,
					"subAssemblies");
	...
	{
		int id1 = assembly1.getId(), id2 = assembly2.getId();
		ImmutableCollection<CompositePart> comp1 = assembly1.getComponents(), comp2 = assembly2
				.getComponents();
		checkEqual(comp1.size(), comp2.size(), assembly1, id1, assembly2, id2,
				"components.size()");
		...
		while (it1.hasNext())
		{
			...
			checkReferences(component1, component2, assembly1, id1, assembly2,
					id2, "components");
			checkEqual(component1.getId(), component2.getId(), assembly1, id1,
					assembly2, id2, "components");
		}
	}

	private void checkDesignLibrariesEqual()
	{
		Index<Integer, CompositePart> library1 = setup1
				.getCompositePartIdIndex(), library2 = setup2
				.getCompositePartIdIndex();
		checkReferences(library1, library2, setup1, 0, setup2, 0,
				"CompositePart.id index");

		Iterator<CompositePart> it1 = library1.iterator(), it2 = library2
				.iterator();
		while (it1.hasNext())
		{
			if (!it2.hasNext())
				reportError(setup1, 0, setup2, 0,
						"CompositePart.id index size differences");

			CompositePart component1 = it1.next(), component2 = it2.next();
			checkReferences(component1, component2, setup1, 0, setup2, 0,
					"CompositePart.id index");
			...
			CompositePart component2)
	{
		...
		Document doc1 = component1.getDocumentation(), doc2 = component2
				.getDocumentation();
		checkReferences(doc1, doc2, component1, id1, component2, id2,
				"documentation");
		checkDocumentsEqual(doc1, doc2);

		ImmutableCollection<BaseAssembly> usedIn1 = component1.getUsedIn(), usedIn2 = component2
				.getUsedIn();
		checkEqual(usedIn1.size(), usedIn2.size(), component1, id1, component2,
				id2, "usedIn.size()");

		Iterator<BaseAssembly> it1 = usedIn1.iterator(), it2 = usedIn2
				.iterator();
		while (it1.hasNext())
		{
			BaseAssembly assembly1 = it1.next(), assembly2 = it2.next();
			checkReferences(assembly1, assembly2, component1, id1, component2,
					id2, "usedIn");
			checkEqual(assembly1.getId(), assembly2.getId(), component1, id1,
					component2, id2, "usedIn");
		}

		AtomicPart root1 = component1.getRootPart(), root2 = component2
				.getRootPart();
		checkReferences(root1, root2, component1, id1, component2, id2,
				"rootPart");
		checkEqual(root1.getId(), root2.getId(), component1, id1, component2,
				id2, "rootPart");

		LargeSet<AtomicPart> parts1 = component1.getParts(), parts2 = component2
				.getParts();
		checkReferences(parts1, parts2, component1, id1, component2, id2,
				"parts");
		checkEqual(parts1.size(), parts2.size(), component1, id1, component2,
				id2, "parts.size()");

		Iterator<AtomicPart> partsIt1 = parts1.iterator(), partsIt2 = parts2
				.iterator();
		while (partsIt1.hasNext())
		{
			AtomicPart part1 = partsIt1.next(), part2 = partsIt2.next();
			checkReferences(part1, part2, component1, id1, component2, id2,
					"parts");
	...
	private void checkDocumentsEqual(Document doc1, Document doc2)
	{
		...
		checkEqual(doc1.getTitle(), doc2.getTitle(), doc1, id1, doc2, id2,
				"title");
		checkEqual(doc1.getText(), doc2.getText(), doc1, id1, doc2, id2, "text");
		checkReferences(doc1.getCompositePart(), doc2.getCompositePart(), doc1,
				id1, doc2, id2, "part");
	}
	...
	private void checkAtomicPartsEqual(AtomicPart part1, AtomicPart part2)
	{
		...
		checkReferences(part1.getPartOf(), part2.getPartOf(), part1, id1,
				part2, id2, "partOf");

		ImmutableCollection<Connection> to1 = part1.getToConnections(), to2 = part2
				.getToConnections();
	...
	private void checkConnectionsEqual(Connection conn1, Connection conn2)
	{
		...
		checkEqual(conn1.getLength(), conn2.getLength(), conn1, 0, conn2, 0,
				"length");
		...
		AtomicPart dest1 = conn1.getDestination(), dest2 = conn2
				.getDestination();
	...
	{
		Index<Integer, AtomicPart> atomicPartIdIndex1 = setup1
				.getAtomicPartIdIndex(), atomicPartIdIndex2 = setup2
				.getAtomicPartIdIndex();
		checkEqual(atomicPartIdIndex1, atomicPartIdIndex2, "AtomicPart.id");

		Index<Integer, LargeSet<AtomicPart>> atomicPartBuildDateIndex1 = setup1
				.getAtomicPartBuildDateIndex(), atomicPartBuildDateIndex2 = setup2
				.getAtomicPartBuildDateIndex();
		checkEqual(atomicPartBuildDateIndex1, atomicPartBuildDateIndex2,
				"AtomicPart.buildDate");

		Index<String, Document> documentTitleIndex1 = setup1
				.getDocumentTitleIndex(), documentTitleIndex2 = setup2
				.getDocumentTitleIndex();
		checkEqual(documentTitleIndex1, documentTitleIndex2, "Document.title");

		Index<Integer, CompositePart> compositePartIdIndex1 = setup1
				.getCompositePartIdIndex(), compositePartIdIndex2 = setup2
				.getCompositePartIdIndex();
		checkEqual(compositePartIdIndex1, compositePartIdIndex2,
				"CompositePart.id");

		Index<Integer, BaseAssembly> baseAssemblyIdIndex1 = setup1
				.getBaseAssemblyIdIndex(), baseAssemblyIdIndex2 = setup2
				.getBaseAssemblyIdIndex();
		checkEqual(baseAssemblyIdIndex1, baseAssemblyIdIndex2,
				"BaseAssembly.id");

		Index<Integer, ComplexAssembly> complexAssemblyIdIndex1 = setup1
				.getComplexAssemblyIdIndex(), complexAssemblyIdIndex2 = setup2
				.getComplexAssemblyIdIndex();
		checkEqual(complexAssemblyIdIndex1, complexAssemblyIdIndex2,
				"ComplexAssembly.id");
	}
	...
	private void checkEqual(Index index1, Index index2, String indexName)
	{
		for (Object key1 : index1.getKeys())
		{
			...
			if (val2 == null)
				throw new RuntimeError("Indexes " + indexName
						+ ": index2 does not contain key " + key1.toString());

			if (val1 instanceof Iterable)
			{
				checkEqual((Iterable) val1, (Iterable) val2, indexName
						+ " at key " + key1.toString());
				continue;
			}

			if (!val1.equals(val2))
				throw new RuntimeError("Indexes " + indexName
						+ ": different values for key " + key1.toString()
						+ " --> [" + val1.toString() + "] != ["
						+ val2.toString() + "]");
		}
	...
	private void checkEqual(Iterable setIter1, Iterable setIter2, String setName)
	{
		...
		for (Object obj1 : setIter1)
		{
			if (!set2.contains(obj1))
				throw new RuntimeError("Sets " + setName + ": element ["
						+ obj1.toString() + "] not in set2");
		}
		for (Object obj2 : setIter2)
		{
			if (!set1.contains(obj2))
				throw new RuntimeError("Sets " + setName + ": element ["
						+ obj2.toString() + "] not in set1");
		}
	}
	...
	private void reportError(Object obj1, int id1, Object obj2, int id2,
			String message)
	{
		throw new RuntimeError("Object " + obj1.toString() + " with id = "
				+ id1 + " != object " + obj2.toString() + " with id = " + id2
				+ ": " + message);
	}

	private void checkEqual(int val1, int val2, Object obj1, int id1,
			Object obj2, int id2, String attribute)
	{
		if (val1 != val2)
	...
	private void checkEqual(String val1, String val2, Object obj1, int id1,
			Object obj2, int id2, String attribute)
	{
		if (!val1.equals(val2))
			reportError(obj1, id1, obj2, id2, "attribute " + attribute
	...
	private void checkReferences(Object val1, Object val2, Object obj1,
			int id1, Object obj2, int id2, String attribute)
	{
