...
public class AtomicPartBuilder extends DesignObjBuilder
{
			...
			Index<Integer, LargeSet<AtomicPart>> partBuildDateIndex)
	{
		...
		idPool = BackendFactory.instance
			...
			throws OperationFailedException
	{
		...
		int buildDate = createBuildDate(Parameters.MinAtomicDate,
		...
		AtomicPart part = designObjFactory.createAtomicPart(id, type,
				buildDate, x, y);
	...
	public void unregisterAndRecycleAtomicPart(AtomicPart part)
	{
		...
		BaseOperation.removeAtomicPartFromBuildDateIndex(partBuildDateIndex,
				part);
