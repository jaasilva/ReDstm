...
public class ModuleBuilder extends DesignObjBuilder
{
	...
	public Module createRegisterModule() throws OperationFailedException
	{
		...
		int buildDate = createBuildDate(Parameters.MinModuleDate,
				Parameters.MaxModuleDate);

		Module module = designObjFactory.createModule(moduleId, type,
				buildDate, manual);

		ComplexAssembly designRoot = (ComplexAssembly) assemblyBuilder
				.createAndRegisterAssembly(module, null);
