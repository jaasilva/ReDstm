...
public abstract class OperationExecutorFactory
{
	...
	public static void executeSequentialOperation(final Operation op)
			throws InterruptedException
	{
		Thread opThread = ThreadFactory.instance.createThread(new Runnable()
		{
			public void run()
			{
				OperationExecutor operationExecutor = instance
						.createOperationExecutor(op);
				try
				{
				...
				catch (OperationFailedException e)
				{
					throw new RuntimeError(
							"Unexpected failure of a sequential operation "
									+ op);
				}
