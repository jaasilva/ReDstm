...
public final class PrimeFinder
{
	 ...
	 * prime number <= desired capacity * 1.11. Therefore, primes can be
	 * retrieved which are quite close to any desired capacity, which in turn
	 * avoids wasting memory. For example, the list includes
	 ...
	 * to prime capacities such that there exist no better primes. In total
	 * these are about 32*10=320 numbers -> 1 KB of static memory needed. If you
	 * are stingy, then delete every second or fourth chunk.
	 */
