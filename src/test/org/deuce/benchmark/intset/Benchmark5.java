 ...
 * @since 0.1
 */
public class Benchmark5 implements org.deuce.benchmark.Benchmark
{
	@Bootstrap(id = 3)
	public IntSet m_set;
	int m_range = 1 << 16;
	...
	{
		return new BenchmarkThread5(m_set, m_range, m_rate);
	}
	...
	public String getStats(org.deuce.benchmark.BenchmarkThread[] threads)
	{
		...
		{
			add += ((BenchmarkThread5) threads[i]).m_nb_add;
			remove += ((BenchmarkThread5) threads[i]).m_nb_remove;
			contains += ((BenchmarkThread5) threads[i]).m_nb_contains;
		}
