...
@ExcludeTM
public class _Profiler
{
	static public boolean enabled = false;
	static protected Object lock = new Object();

	static protected List<_Profiler> profilers = new LinkedList<_Profiler>();

	static public void addProfiler(_Profiler prof)
	{
	...
	public _Profiler(boolean remote)
	{
		this.remote = remote;
		// if (remote)
		// txRemote++;
	...
	public static void print()
	{
		...
		System.out.printf("      avg = %d mms\n", txTimeAppAvg / 1000);
		System.out.printf("      max = %d mms\n", txTimeAppMax / 1000);
		System.out.printf("      min = %d mms\n", txTimeAppMin / 1000);
