...
public class ByteArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(ByteArrayContainer.class);
	public static final String DESC = Type.getDescriptor(ByteArrayContainer.class);
	
	public static final String ARRAY_FIELD_DESC = Type.getDescriptor(byte[].class);
	public byte[] array;
