...
public class ObjectArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(ObjectArrayContainer.class);
	public static final String DESC = Type.getDescriptor(ObjectArrayContainer.class);
