...
public class ShortArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(ShortArrayContainer.class);
	public static final String DESC = Type.getDescriptor(ShortArrayContainer.class);
	
	public static final String ARRAY_FIELD_DESC = Type.getDescriptor(short[].class);
	public short[] array;
