...
public class DoubleArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(DoubleArrayContainer.class);
	public static final String DESC = Type.getDescriptor(DoubleArrayContainer.class);
	
	public static final String ARRAY_FIELD_DESC = Type.getDescriptor(double[].class);
	public double[] array;
