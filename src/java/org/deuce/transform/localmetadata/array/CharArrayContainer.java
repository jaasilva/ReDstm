...
public class CharArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(CharArrayContainer.class);
	public static final String DESC = Type.getDescriptor(CharArrayContainer.class);
	
	public static final String ARRAY_FIELD_DESC = Type.getDescriptor(char[].class);
	public char[] array;
