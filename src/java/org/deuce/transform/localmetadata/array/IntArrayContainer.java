...
public class IntArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(IntArrayContainer.class);
	public static final String DESC = Type.getDescriptor(IntArrayContainer.class);
	
	public static final String ARRAY_FIELD_DESC = Type.getDescriptor(int[].class);
	public int[] array;
