...
public class BooleanArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(BooleanArrayContainer.class);
	public static final String DESC = Type.getDescriptor(BooleanArrayContainer.class);
	
	public static final String ARRAY_FIELD_DESC = Type.getDescriptor(boolean[].class);
