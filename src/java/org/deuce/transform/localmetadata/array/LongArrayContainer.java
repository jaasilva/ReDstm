...
public class LongArrayContainer extends ArrayContainer {
	public static final String NAME = Type.getInternalName(LongArrayContainer.class);
	public static final String DESC = Type.getDescriptor(LongArrayContainer.class);
	
	public static final String ARRAY_FIELD_DESC = Type.getDescriptor(long[].class);
	public long[] array;
