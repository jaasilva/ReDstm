...
public class FramesCodeVisitor extends ClassAdapter
{
	...
	public FramesCodeVisitor(String className)
	{
		...
		super(new CommonClassWriter(ClassWriter.COMPUTE_MAXS
				| ClassWriter.COMPUTE_FRAMES, className));
	}
			...
			final String[] interfaces)
	{
		...
		super.visit(JAVA5_VERSION, access, name, signature, superName,
				interfaces);
	}
	...
	/**
	 * FIXMEs This is a work around and should be fixed better in the future. By
