...
public class MethodTransformer implements MethodVisitor
{
			...
			FieldsHolder fieldsHolder)
	{
		...
		DuplicateMethod duplicateMethod = new DuplicateMethod(copyMethod,
				isStatic, newMethod, fieldsHolder);
		AnalyzerAdapter analyzerAdapter = new AnalyzerAdapter(className,
				access, methodName, descriptor, duplicateMethod);
	...
	public AnnotationVisitor visitAnnotation(String desc, boolean visible)
	{
		...
		if (!desc.contains("org/junit")) // TODOs find another way
