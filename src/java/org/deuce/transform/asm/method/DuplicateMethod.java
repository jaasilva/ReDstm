...
public class DuplicateMethod extends MethodAdapter
{
			...
			String desc)
	{
		...
		mv.visitFieldInsn(Opcodes.GETSTATIC, fieldsHolderName,
				Util.getAddressField(name), "J");
		Label l1 = new Label();
	...
	private void addBeforeReadCall(String owner, String name)
	{
		...
		super.visitMethodInsn(Opcodes.INVOKESTATIC,
				...
				ContextDelegator.BEFORE_READ_METHOD_DESC);
	}
	...
	public void visitInsn(int opcode)
	{
		...
		case Opcodes.AALOAD:
			...
			String arrayType = (String) this.analyzerAdapter.stack
					.get(this.analyzerAdapter.stack.size() - 2);
