...
public class ClassTransformer extends ByteCodeVisitor implements FieldsHolder
{
	...
	final static private String ANNOTATION_NAME = Type
			...
			String signature, Object value)
	{
		...
		// Define as constant
		int fieldAccess = Opcodes.ACC_FINAL | Opcodes.ACC_PUBLIC
			...
			String desc, String signature, String[] exceptions)
	{
		...
		MethodVisitor originalMethod = super.visitMethod(access, name, desc,
		...
		if (name.equals("<clinit>"))
		{
			...
			MethodVisitor staticMethodVisitor = fieldsHolder
					.getStaticMethodVisitor();
			return createStaticMethodTransformer(originalMethod,
					staticMethodVisitor);
		}
		...
		// if has one.
		MethodVisitor copyMethod = super.visitMethod(
			...
			String signature, String[] exceptions)
	{
		...
		copyMethod.visitMethodInsn(Opcodes.INVOKESTATIC,
				...
				ContextDelegator.IRREVOCABLE_METHOD_NAME,
				ContextDelegator.IRREVOCABLE_METHOD_DESC);
		...
		if (!exclude)
		{
			...
			{ // Build a dummy ordinal() method
				MethodVisitor ordinalMethod = super.visitMethod(
						...
						"(Lorg/deuce/transaction/Context;)I", null, null);
	...
	private StaticMethodTransformer createStaticMethodTransformer(
			MethodVisitor originalMethod, MethodVisitor staticMethod)
	{
		return new StaticMethodTransformer(originalMethod, staticMethod,
				fields, staticField, className,
