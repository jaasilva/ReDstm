...
public class ContextDelegator {
  ...
  static public String ARRAY_CONTAINER_DESC = Type.getDescriptor(ArrayContainer.class);
  static public String MULTI_ARRAY_CONTAINER_DESC = Type.getDescriptor(MultiArrayContainer.class);
  static public String OBJECT_ARRAY_CONTAINER_DESC = Type.getDescriptor(ObjectArrayContainer.class);
  static public String INT_ARRAY_CONTAINER_DESC = Type.getDescriptor(IntArrayContainer.class);
  static public String SHORT_ARRAY_CONTAINER_DESC = Type.getDescriptor(ShortArrayContainer.class);
  static public String FLOAT_ARRAY_CONTAINER_DESC = Type.getDescriptor(FloatArrayContainer.class);
  static public String CHAR_ARRAY_CONTAINER_DESC = Type.getDescriptor(CharArrayContainer.class);
  static public String BOOLEAN_ARRAY_CONTAINER_DESC = Type.getDescriptor(BooleanArrayContainer.class);
  static public String BYTE_ARRAY_CONTAINER_DESC = Type.getDescriptor(ByteArrayContainer.class);
  static public String LONG_ARRAY_CONTAINER_DESC = Type.getDescriptor(LongArrayContainer.class);
  static public String DOUBLE_ARRAY_CONTAINER_DESC = Type.getDescriptor(DoubleArrayContainer.class);
  ...
  static private String WRITE_METHOD_OBJ_DESC_META = "(Ljava/lang/Object;" + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")V";
  static private String WRITE_METHOD_ARRAY_DESC_META = "(" + ARRAY_CONTAINER_DESC + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")V";
  
  static private String STATIC_WRITE_METHOD_BOOLEAN_DESC_META = "(Z" + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")V";
  ...
  static private String STATIC_WRITE_METHOD_DOUBLE_DESC_META = "(D" + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")V";
  static private String STATIC_WRITE_METHOD_OBJ_DESC_META = "(Ljava/lang/Object;" + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")V";
  static private String STATIC_WRITE_METHOD_ARRAY_DESC_META = "(" + ARRAY_CONTAINER_DESC + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")V";
  ...
  static private String READ_METHOD_OBJ_DESC_META = "(Ljava/lang/Object;" + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")Ljava/lang/Object;";
  static private String READ_METHOD_ARRAY_DESC_META = "(" + ARRAY_CONTAINER_DESC + TXFIELD_DESCRIPTOR + Context.CONTEXT_DESC +")"+ARRAY_CONTAINER_DESC;
  
  static public String WRITE_ARRAY_METHOD_BOOLEAN_DESC_META = "("+BOOLEAN_ARRAY_CONTAINER_DESC+"IZ" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_BYTE_DESC_META = "("+BYTE_ARRAY_CONTAINER_DESC+"IB" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_CHAR_DESC_META = "("+CHAR_ARRAY_CONTAINER_DESC+"IC" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_SHORT_DESC_META = "("+SHORT_ARRAY_CONTAINER_DESC+"IS" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_INT_DESC_META = "("+INT_ARRAY_CONTAINER_DESC+"II" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_LONG_DESC_META = "("+LONG_ARRAY_CONTAINER_DESC+"IJ" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_FLOAT_DESC_META = "("+FLOAT_ARRAY_CONTAINER_DESC+"IF" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_DOUBLE_DESC_META = "("+DOUBLE_ARRAY_CONTAINER_DESC+"ID" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_OBJ_DESC_META = "("+OBJECT_ARRAY_CONTAINER_DESC+"ILjava/lang/Object;" + Context.CONTEXT_DESC +")V";
  static public String WRITE_ARRAY_METHOD_MULTI_DESC_META = "("+MULTI_ARRAY_CONTAINER_DESC+"I" + ARRAY_CONTAINER_DESC + Context.CONTEXT_DESC + ")V";
  
  static public String READ_ARRAY_METHOD_BOOLEAN_DESC_META = "("+BOOLEAN_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")Z";
  static public String READ_ARRAY_METHOD_BYTE_DESC_META = "("+BYTE_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")B";
  static public String READ_ARRAY_METHOD_CHAR_DESC_META = "("+CHAR_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")C";
  static public String READ_ARRAY_METHOD_SHORT_DESC_META = "("+SHORT_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")S";
  static public String READ_ARRAY_METHOD_INT_DESC_META = "("+INT_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")I";
  static public String READ_ARRAY_METHOD_LONG_DESC_META = "("+LONG_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")J";
  static public String READ_ARRAY_METHOD_FLOAT_DESC_META = "("+FLOAT_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")F";
  static public String READ_ARRAY_METHOD_DOUBLE_DESC_META = "("+DOUBLE_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")D";
  static public String READ_ARRAY_METHOD_OBJ_DESC_META = "("+OBJECT_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")Ljava/lang/Object;";
  static public String READ_ARRAY_METHOD_MULTI_DESC_META = "("+MULTI_ARRAY_CONTAINER_DESC+"I" + Context.CONTEXT_DESC +")"+ARRAY_CONTAINER_DESC;
...
//  }
  ...
  final static public int OBJECT_ARR_BASE = AddressUtil.arrayBaseOffset(Object[].class);
  ...
  final static public int OBJECT_ARR_SCALE = AddressUtil.arrayIndexScale(Object[].class);
  ...
  static public double onArrayReadAccess( double[] arr, int index, IContext context) {
	...
	static public boolean onArrayReadAccess(BooleanArrayContainer arr, int index,
			IContext context)
	{
		TxField elem = arr.metadata[index];
		((ContextMetadata) context).beforeReadAccess(elem);
  ...
  static public void onArrayWriteAccess( double[] arr, int index, double value, IContext context) {
	...
	static public void onArrayWriteAccess(MultiArrayContainer arr, int index,
		...
		((ContextMetadata) context).onWriteAccess(value, (TxField) arr.metadata[index]);
	}
	static public <T> void onArrayWriteAccess(ObjectArrayContainer arr, int index,
			T value, IContext context) {
		((ContextMetadata) context).onWriteAccess(value, (TxField) arr.metadata[index]);
	}
