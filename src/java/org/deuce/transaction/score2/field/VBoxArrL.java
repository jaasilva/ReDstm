 ...
 */
@ExcludeTM
public class VBoxArrL extends TxField implements VBoxL
{
	...
	{
		super(arr, idx);
		version = new VersionL(0, readLong(), null);
	}
	...
	{
		VersionL ver = new VersionL(Integer.MAX_VALUE, newValue, version);
		this.version.value = readLong();
		this.version = ver;
		writeLong(ver.value);
	...
	static
	{
		try
		{
			__LOCK_FIELD__ = AddressUtil.getAddress(VBoxArrL.class
