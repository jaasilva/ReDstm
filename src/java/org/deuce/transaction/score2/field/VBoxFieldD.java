 ...
 */
@ExcludeTM
public class VBoxFieldD extends TxField implements VBoxD
{
	...
	{
		super(ref, address);
		version = new VersionD(0, readDouble(), null);
	}
	...
	public void commit(double newValue, int txNumber)
	{
		...
		this.version.value = readDouble();
		this.version = ver;
		writeDouble(ver.value);
	...
	static
	{
		try
		{
			__LOCK_FIELD__ = AddressUtil.getAddress(VBoxFieldD.class
