...
public abstract class ObjectSerializer {
	...
	public static final String WRITE_METHOD_DESC = "("+UniqueObject.DESC+")"+Type.getDescriptor(Object.class);
	public abstract Object writeReplaceHook(UniqueObject obj)
			throws ObjectStreamException;
	
	public static final String READ_METHOD_NAME = "readResolveHook";
	public static final String READ_METHOD_DESC = "("+UniqueObject.DESC+")"+Type.getDescriptor(Object.class);
