...
do
	...
	echo "set yrange [0:22000]" >>$pscript
	#echo "set yrange [0:10000]" >>$pscript
	...
	# -- WITH DEV (needs 5 RUNS) --
		#echo "plot \"${data}\" using 1:2:3:4 with yerrorlines linestyle 1 title columnhead(2), \\" >>$pscript
		#echo "'' using 1:5:6:7 with yerrorlines linestyle 2 title columnhead(3), \\" >>$pscript
		#echo "'' using 1:8:9:10 with yerrorlines linestyle 3 title columnhead(4)" >>$pscript
	# -- WITHOUT DEV --
